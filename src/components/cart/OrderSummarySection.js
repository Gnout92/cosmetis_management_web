...
const OrderSummarySection = ({
  ...
  const handleCheckoutClick = () => {
    if (typeof onOpenOrderModal === 'function') {
      onOpenOrderModal();
    } else {
      console.warn('onOpenOrderModal is not a function or missing');
    }
  };
  return (
    <div className={styles.orderSummarySection}>
      <div className={styles.orderSummary}>
        <h2 className={styles.summaryTitle}>
          <DollarSign size={24} className="s  ummary-icon" /> Tóm tắt đơn hàng
        </h2>
